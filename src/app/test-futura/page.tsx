...
export default function TestFuturaPage() {
  return (
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 
            className="text-4xl font-bold text-gray-900 mb-4 font-futura"
            style={{ 
              fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
              fontWeight: '800',
              letterSpacing: '-0.02em',
              textTransform: 'uppercase'
            }}
          >
            Test des Combinaisons de Couleurs OSOM avec Futura
          </h1>
          <p 
            className="text-xl text-gray-600 font-futura"
            style={{ 
              fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
              fontWeight: '600',
          ...
          <div className="mt-4 inline-block bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-bold font-futura" style={{ fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }}>
            🎨 POLICE FUTURA ACTIVÉE
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10 p-6 h-full flex flex-col">
                ...
                <div className="mb-6">
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <span 
                        className="text-xl font-bold font-futura text-white"
                      >
                        OSOM
                      </span>
                    </div>
                  ...
                  <div className="mt-4 text-center">
                    <h3 
                      className="text-lg font-bold font-futura"
                ...
                <div className="bg-black/20 backdrop-blur-sm rounded-lg p-4 mb-4">
                  <h4 
                    className="text-2xl font-bold mb-4 text-white font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '800',
                      letterSpacing: '-0.02em',
                  ...
                  {/* Texte de test */}
                  <p 
                    className="mb-4 leading-relaxed text-white/90 font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '600',
                      letterSpacing: '-0.01em'
                ...
                <div className="flex gap-3 mb-4">
                  <button 
                    className="px-6 py-3 rounded-lg font-semibold text-white transition-all duration-300 hover:scale-105 shadow-lg font-futura"
                    style={{ 
                  ...
                  <button 
                    className="px-6 py-3 rounded-lg font-semibold border-2 border-white/80 text-white transition-all duration-300 hover:scale-105 hover:bg-white/10 backdrop-blur-sm font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '700',
                      letterSpacing: '-0.01em'
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {['Certifié CEE', '100% Gratuit', 'DOM-TOM'].map((item, i) => (
                    <span 
                      key={i}
                      className="px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm bg-white/10 text-white border border-white/20 font-futura"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="mt-auto bg-black/30 backdrop-blur-sm rounded-lg p-4">
                  <h5 className="font-semibold mb-3 text-white font-futura">
                    Palette de couleurs :
                  </h5>
                  <div className="grid grid-cols-2 gap-2">
                    {Object.entries(palette.colors).map(([key, color]) => (
                      <div key={key} className="flex items-center gap-2">
                        ...
                        ></div>
                        <span 
                          className="text-xs font-mono text-white/80 font-futura"
                        >
                          {color}
                        </span>
                      </div>
        ...
        >
          <h2 
            className="text-3xl font-bold text-gray-900 mb-6 text-center font-futura"
            style={{ 
              fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
              fontWeight: '800',
              letterSpacing: '-0.02em',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center py-4">
                ...
                <div className="flex items-center">
                  ...
                  <span 
                    className="text-2xl font-bold text-gray-900 font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '800',
                      letterSpacing: '-0.01em'
                ...
                <nav className="hidden md:flex space-x-8">
                  <a 
                    href="#" 
                    className="text-gray-700 hover:text-green-600 transition-colors font-futura"
                    style={{ fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }}
                  >
                    Accueil
                  </a>
                  <a 
                ...
                {/* Bouton CTA */}
                <button 
                  className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:from-green-600 hover:to-blue-700 transition-all duration-300 font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '700'
                  }}
          ...
          <div className="relative min-h-[500px] bg-gradient-to-br from-green-50 via-blue-50 to-green-100 rounded-xl overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              <div className="text-center">
                <h1 
                  className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '800',
                    letterSpacing: '-0.02em',
                ...
                <p 
                  className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '500'
                  }}
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  <button 
                    className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-green-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '700'
                    }}
                  ...
                  <button 
                    className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-green-600 hover:text-white transition-all duration-300 font-futura"
                    style={{ 
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '700'
                    }}
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600">
                  <div className="flex items-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full font-futura" style={{ fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }}>
        ...
        >
          ...
          <div className="mb-12">
            <div className="text-center mb-8">
              <h3 
                className="text-3xl font-bold text-gray-900 mb-4 font-futura"
                style={{ 
                  fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                  fontWeight: '800',
                  letterSpacing: '-0.01em'
              ...
              <p 
                className="text-xl text-gray-600 max-w-3xl mx-auto font-futura"
                style={{ 
                  fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                  fontWeight: '500'
                }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                ...
                <h4 
                  className="text-xl font-bold text-gray-900 mb-3 font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '700'
                  }}
                ...
                <p 
                  className="text-gray-700 mb-4 font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '500'
                  }}
                ...
                <ul className="space-y-2 text-sm text-gray-600 font-futura" style={{ fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }}>
                  <li>• Tubes LED</li>
                  <li>• Panneaux LED</li>
                  <li>• Spots LED</li>
          ...
          <div className="mb-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 border border-green-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h4 
                  className="text-lg font-bold text-gray-900 mb-2 font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '700'
                  }}
                ...
                <p 
                  className="text-gray-600 text-sm font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '500'
                  }}
          ...
          <div className="text-center bg-gradient-to-r from-green-500 to-blue-600 rounded-xl p-8 text-white">
            <h3 
              className="text-3xl font-bold mb-4 font-futura"
              style={{ 
                fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                fontWeight: '800',
                letterSpacing: '-0.01em'
            ...
            <p 
              className="text-xl mb-6 opacity-90 font-futura"
              style={{ 
                fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                fontWeight: '500'
              }}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                className="bg-white text-green-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-lg font-futura"
                style={{ 
                  fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                  fontWeight: '700'
                }}
              ...
              <button 
                className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-green-600 transition-all duration-300 font-futura"
                style={{ 
                  fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                  fontWeight: '700'
                }}
          ...
          <div className="space-y-8">
            {colorPalettes.slice(0, 3).map((palette, index) => (
              <div key={index} className="border border-gray-200 rounded-xl overflow-hidden">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span 
                        className="text-xl font-bold font-futura"
                        style={{ 
                    ...
                    <nav className="hidden md:flex space-x-6">
                      <a href="#" style={{ color: palette.colors.text, fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }} className="hover:opacity-80 font-futura">Accueil</a>
                      <a href="#" style={{ color: palette.colors.text, fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }} className="hover:opacity-80 font-futura">Solutions</a>
                      <a href="#" style={{ color: palette.colors.text, fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }} className="hover:opacity-80 font-futura">CEE</a>
                      <a href="#" style={{ color: palette.colors.text, fontFamily: 'var(--font-futura), Futura, Arial, sans-serif' }} className="hover:opacity-80 font-futura">Contact</a>
                    </nav>
                  </div>
                </div>
                ...
                >
                  <h1 
                    className="text-4xl font-bold mb-4 font-futura"
                    style={{ 
                      color: palette.colors.primary,
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '800',
                  ...
                  <p 
                    className="text-xl mb-8 font-futura"
                    style={{ 
                  ...
                  <button 
                    className="px-8 py-4 rounded-lg font-semibold text-lg hover:opacity-90 transition-all font-futura"
                    style={{ 
                      backgroundColor: palette.colors.primary,
                ...
                >
                  <h2 
                    className="text-2xl font-bold mb-6 text-center font-futura"
                    style={{ 
                      color: palette.colors.primary,
                      fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                      fontWeight: '800'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      ...
                      <h3 
                        className="text-lg font-bold mb-2 font-futura"
                        style={{ 
                          color: palette.colors.primary,
                          fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                          fontWeight: '700'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
              <div className="flex items-center mb-4">
                ...
                <h3 
                  className="text-xl font-bold text-gray-900 font-futura"
                  style={{ 
                    fontFamily: 'var(--font-futura), Futura, Arial, sans-serif',
                    fontWeight: '700',
                    letterSpacing: '-0.01em'
        ...
        <motion.div
          ...
          className="mt-12 bg-white rounded-2xl p-8 shadow-lg"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4 font-futura">
            Test avec Futura Extra Bold
          </h2>
          <div className="space-y-3 text-gray-700">
            <p className="font-futura">• <strong>Typographie Futura</strong> : Police moderne et géométrique</p>
            <p className="font-futura">• <strong>Test de lisibilité</strong> : Voir comment Futura s'harmonise avec chaque palette</p>
            <p className="font-futura">• <strong>Impact visuel</strong> : Futura apporte une touche moderne et professionnelle</p>
            <p className="font-futura">• <strong>Comparaison</strong> : Comparez avec la page /test-colors (Inter) qui contient 52 palettes</p>
          </div>
        </motion.div>
      </div>
    </div>
